...
| NEC-FTG-018 | NEC-SE-GC + FHWA NHI-06-089 | Contacto y pantalla Winkler de losa de cimentación | `NEC-SRC-002` + `PUB-SRC-002` | NEC-SE-GC, secciones 6.4 y 7; FHWA NHI-06-089, secciones 2.6, 6.6 y 8.6 | `domain/mat-footing` | `NEC-FTG-035` a `038` | Contacto y equilibrio automatizados; placa, punzonamiento y armado no evaluados |
...
| NEC-FTG-017 | FHWA + NEC-SE-GC + equilibrio | Contacto de zapata de esquina biaxial | `PUB-SRC-009` + `NEC-SRC-002` + `AXC-CORNER-DER-001` | FHWA NHI-06-089, 6.4.1 y 6.6; NEC-SE-GC 2014, 6.4, 7.1, 7.2.1 y 7.3 | `domain/corner-footing` | `NEC-FTG-031` a `034` | Plano de presión e interacción del núcleo implementados; contacto parcial excluido |
| NEC-FTG-018 | Guía práctica NEC 2015 | Cortante, flexión, acero y desarrollo de zapata de esquina | `NEC-SRC-004` | Secciones 1.10.1, 1.10.5 y 1.10.6 aplicadas a demandas direccionales integradas | `domain/corner-footing` | `NEC-FTG-031` a `034` | Referencia de guía; análisis de placa y punzonamiento de esquina no evaluados |
...
| PUB-SRC-002 | FHWA NHI-06-089 — Soils and Foundations Reference Manual, Vol. II | PDF oficial FHWA, 2006; secciones 2.6, 6.6 y 8.6. | Losa multicolumna, presión lineal de base rígida y relación Winkler `q=k·s`, con sus advertencias de aplicabilidad. | Registrada y aplicada a `AXC-MAT-001` |
...
| PUB-SRC-009 | FHWA NHI-06-089 — Soils and Foundations Reference Manual, Vol. II | Publicación oficial de 2006; 6.4.1 define excentricidades y dimensiones efectivas en dos direcciones; 6.6 documenta la base rígida con presión lineal. | Delimitar excentricidad biaxial y contacto completo. | Registrada; el plano y la interacción se derivan por estática en `AXC-CORNER-DER-001` |
...
- [FHWA NHI-06-089 — Soils and Foundations Reference Manual, Vol. II](https://www.fhwa.dot.gov/engineering/geotech/pubs/010943.pdf)
