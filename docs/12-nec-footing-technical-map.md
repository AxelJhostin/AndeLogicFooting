...
| Zapatas aisladas, combinadas, losas y geometría superficial | NEC-SE-GC, PDF 48-52, secciones 6.4 y 7 | Delimitar geometría, excentricidad, equilibrio de presiones y capacidad externa. | Ocho familias activas dentro de sus alcances documentados; la losa usa contacto rígido y pantalla Winkler, con placa estructural no evaluada. |
...
3. Mantener `AXC-CORNER-001` y `AXC-CORNER-DER-001` como caso y derivación obligatorios para cualquier cambio del modelo biaxial.
...
- Cada presión no uniforme se habilita solo dentro de su documento de alcance. El plano biaxial de la losa está limitado por `23-mat-foundation-scope.md`; no habilita contacto parcial, momentos transferidos ni diseño estructural de placa.
