...
| Punzonamiento | NEC-SE-HM, referencias de cortante y punzonamiento; guía de hormigón, PDF 82-86, secciones 1.10.2-1.10.4 | Perímetro crítico, demanda y alternativas de comprobación. | Demanda con perímetro declarado; resistencia pendiente. |
...
| Longitud de desarrollo y anclaje | NEC-SE-HM, PDF 75 y 110-111; guía de hormigón, PDF 89, sección 1.10.6 | Determinar si una barra desarrolla la demanda disponible con la geometría real. | Pendiente. |
