...
export function buildStripResultCards(analysis: StripFootingAnalysis | null): ResultCard[] {
  return [
    ...
    { id: 'strip-flexure', title: 'Flexión transversal', state: state(analysis ? true : undefined), value: analysis ? `${analysis.structural.flexureDemandKnMPerM.toFixed(1)} kN·m/m` : '—', detail: 'Demanda en cara de muro', destination: 'section' },
